    ...
    targets: [
        .executableTarget(
            ...
            exclude: [
                ...
                "codex-scan.py", "kimi-scan.py", "launch.py", "leader-hook.py",
                "makeicon.swift", "name.py", "pin.py", "scan.py", "test_switch.py",
                "unread.py", "__pycache__",
            ],
            sources: ["LeaderApp.swift", "EmbeddedTerminal.swift", "QuakeTerminal.swift",
                      "DesignSystem.swift", "Model.swift", "UnifiedSession.swift",
                      "SessionStore.swift", "Activity.swift",
